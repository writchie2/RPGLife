        ...
        <View style={styles.modalContainer}>
          <View style={styles.scrollContainer}>
            ...
            <Text style={styles.contentText}>
              We appreciate you making an account, {userData?.username}!
            </Text>
            <Text style={styles.contentText}>
              This is the Capstone Project for Group 7 for CS at UWM 2025
            </Text>
            <Text style={styles.contentText}>
              Created by: Conor Brhely, Magan Greenfield, Ishika Patel, Henry
              Ritchie, Dillan Smith
            </Text>
          </View>
