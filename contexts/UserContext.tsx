...
*/
  ...
  */
        ...
        useEffect(() => {
          ...
          const questsCollectionRef = collection(db, "users", user.uid, "quests");
          const skillsCollectionRef = collection(db, "users", user.uid, "skills");
        
          let checkpointUnsubscribers: Record<string, () => void> = {};
          ...
          const unsubscribeQuests = onSnapshot(questsCollectionRef, (querySnapshot) => {
            ...
            const updatedQuests = querySnapshot.docs.map((doc) => {
              ...
              return {
                ...
                dueDate: toMidnight(data.dueDate?.toDate?.()) || null,
            ...
            updatedQuests.forEach((quest: Quest) => {
              ...
              checkpointUnsubscribers[quest.id] = unsubscribeCheckpoints;
            });
