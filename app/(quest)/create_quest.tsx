...
import {Text, StyleSheet, TextInput, Button, TouchableOpacity, SafeAreaView, ScrollView, Pressable, View} from "react-native";
...
export default function CreateQuestScreen() {
    ...
    // Give some level of navigation back to Quest screen
    useEffect(() => {
        const backAction = () => {
          router.back(); // Navigate back to Quest
    ...
    // Likely misunderstanding how setting a date field works. Double check this!
    ...
    const createQuest = async () => {
        ...
        if (
              ...
              questDescription.trim().length === 0 ||
              !dateSelected
            ) {
              Alert.alert("Error", "Please fill out Quest Name, Description, and Due Date");
              return;
            }
    }
        return (
